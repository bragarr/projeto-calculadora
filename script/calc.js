...
const botaoDecimal = document.querySelector(".botao__decimais")
const casaDecimal1 = document.querySelector()
const casaDecimal2 = document.querySelector()
const casaDecimal3 = document.querySelector()
const casaDecimal4 = document.querySelector()
const caracteres = ["/","*","+","-","."];
const operacoes = ["/","*","+","-"]
let resultado = false;
